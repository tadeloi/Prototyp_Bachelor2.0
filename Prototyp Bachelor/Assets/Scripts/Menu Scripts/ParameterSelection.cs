...
public class ParameterSelection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < parameterRenderSettings.Length; i++)
        {
            ...
            if(i == 0)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(false, 5f, 5f, (FogMode)1, new Color(1,1,1,1));
            }
            //Horror
            else if (i == 1)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, 0.1f, 1.8f, (FogMode)1, new Color(0.1f, 0.12f, 0.1f, 1f),1f);
            }
            //Cozy
            else if (i == 2)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, .8f, 6.0f, (FogMode)2, new Color(0.85f, 0.75f, 0.6f, 1f));
            }
            //Fantasy
            else if (i == 3)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, .2f, 4.0f, (FogMode)2, new Color(0.4f, 0.15f, 0.6f, 1f));
            }
            //SciFi
            else if (i == 4)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, .5f, 5.0f, (FogMode)3, new Color(0.05f, 0.15f, 0.35f, 1f));
            }
            //Logik
            else if (i == 5)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, 1f, 8.0f, (FogMode)1, new Color(0.9f, 0.9f, 0.95f, 1f));
            }
            //Retro
            else if (i == 6)
            {
                parameterRenderSettings[i].renderSettings = new RenderSettingsStorage(true, .3f, 3.5f, (FogMode)2, new Color(0.7f, 0.4f, 0.1f, 1f));
            }
        }
...
{
    RenderSettingsStorage settings = parameterRenderSettings[(int)category].renderSettings;
